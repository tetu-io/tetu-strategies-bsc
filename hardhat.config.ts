...
export default {
  ...
  networks: {
    hardhat: {
      ...
      timeout: 99999999,
      // gas: argv.hardhatChainId === 56 ? 19_000_000 : 9_000_000,
      forking: {
        url: argv.hardhatChainId === 56 ? argv.bscRpcUrl : undefined,
        blockNumber: argv.hardhatChainId === 56 ? argv.bscForkBlock !== 0 ? argv.bscForkBlock : undefined : undefined
      },
      accounts: {
